...
export function CallTranscriptView() {
  ...
  return (
    <div className="call-transcript-container">
      ...
      {callLog.summary && (
        <div style={{ margin: '1rem', padding: '1.5rem', background: 'var(--brand-50)', border: '1px solid var(--brand-200)', borderRadius: 'var(--radius-lg)' }}>
          <h3 style={{ margin: '0 0 0.5rem 0', color: 'var(--brand-700)', fontSize: '1.1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
             <Sparkles size={18} /> Call Summary (Generated by AI)
          </h3>
