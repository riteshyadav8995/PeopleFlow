    ...
    <div className="voice-dashboard-container page-container">
      ...
      <div className="voice-hero">
        ...
        <div className="flex gap-4">
          <Button variant="secondary" leftIcon={<History size={18} />} onClick={() => navigate('/organization/voice-agent/history')} style={{ padding: '0.75rem 1.5rem', fontSize: '1rem', borderRadius: '2rem' }}>
            History
          </Button>
